...
import BorrowingPowerInstance from './BorrowingPowerInstance.jsx';
import AdUnit from './AdUnit.jsx';
import { VersionFooter } from './VersionFooter.jsx';
import PageHead from './PageHead.jsx';
import ShareModal from './ShareModal.jsx';
import './BorrowingPowerCalc.css';
...
export default function BorrowingPowerCalc() {
  ...
  const handleShare = useCallback(async () => {
    if (navigator.share) await navigator.share({ title: 'Borrowing Power Calculator — 2176 Studios', url: window.location.href });
    else setModal('share');
  }, []);

  return (
    <div className="calc-page">
      <PageHead calcId="borrowingpower" />
      ...
      <div className="calc-instances" data-count="1">
        <BorrowingPowerInstance instanceKey="" theme={theme} isComparison={false} />
      </div>
      ...
      <VersionFooter calcId="borrowingpower" />
