...
import RentVBuyInstance from './RentVBuyInstance.jsx';
import AdUnit from './AdUnit.jsx';
import { VersionFooter } from './VersionFooter.jsx';
import PageHead from './PageHead.jsx';
import ShareModal from './ShareModal.jsx';
import './RentVBuyCalc.css';
...
export default function RentVBuyCalc() {
  ...
  const handleShare = useCallback(async () => {
    if (navigator.share) await navigator.share({ title: 'Rent vs. Buy Calculator — 2176 Studios', url: window.location.href });
    else setModal('share');
  }, []);

  return (
    <div className="calc-page">
      <PageHead calcId="rentvbuy" />
      ...
      <div className="calc-instances" data-count="1">
        <RentVBuyInstance instanceKey="" theme={theme} isComparison={false} />
      </div>
