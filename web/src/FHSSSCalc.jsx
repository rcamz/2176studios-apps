...
export default function FHSSSCalc() {
  ...
  const handleShare = useCallback(async () => {
    if (navigator.share) await navigator.share({ title: 'FHSSS Calculator — 2176 Studios', url: window.location.href });
    else setModal('share');
  }, []);
  ...
  return (
    <div className="calc-page">
      ...
      <div className="calc-instances" data-count="1">
        <FHSSSInstance instanceKey="" theme={theme} isComparison={false} />
      </div>
