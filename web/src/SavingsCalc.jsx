...
export default function SavingsCalc() {
  ...
  const handleShare = useCallback(async () => {
    if (navigator.share) await navigator.share({ title: 'Savings Calculator — 2176 Studios', url: window.location.href });
    else setModal('share');
  }, []);

  return (
    <div className="calc-page">
      <PageHead calcId="savings" />
      ...
      <div className="calc-instances" data-count="1">
        <SavingsInstance instanceKey="" theme={theme} isComparison={false} />
      </div>
