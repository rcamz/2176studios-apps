...
import RetirementInstance from './RetirementInstance.jsx';
...
export default function RetirementCalc() {
  ...
  const handleShare = useCallback(async () => {
    if (navigator.share) await navigator.share({ title: 'Retirement & Super Calculator — 2176 Studios', url: window.location.href });
    else setModal('share');
  }, []);

  return (
    <div className="calc-page">
      <PageHead calcId="retirement" />
      ...
      <div className="calc-instances" data-count="1">
        <RetirementInstance instanceKey="" theme={theme} isComparison={false} />
      </div>
      ...
      <VersionFooter calcId="retirement" />
