...
const IconShare = () => (
  <svg width="15" height="15" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
    <circle cx="3" cy="8" r="1.75"/><circle cx="13" cy="3" r="1.75"/><circle cx="13" cy="13" r="1.75"/>
    <line x1="4.7" y1="7.1" x2="11.3" y2="3.9"/><line x1="4.7" y1="8.9" x2="11.3" y2="12.1"/>
  </svg>
);
  ...
  return (
    <div className="calc-page">
      ...
      <div className="calc-instances" data-count="1">
        <CGTInstance instanceKey="" label="Scenario A" onRemove={null} theme={theme} isComparison={false} />
      </div>
