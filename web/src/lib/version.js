...
export const CALCS = [
  ...
  },
  {
    ...
    deps: ['sitefooter', 'amortize', 'lmi', 'format', 'urlState', 'styles', 'tokens'],
  },
  {
    id: 'paytax', name: 'Pay / Tax', href: '/paytaxcalc', version: '2.1.1',
    paths: ['web/src/PayTaxInstance.jsx', 'web/src/PayTaxCalc.jsx'],
    deps: ['sitefooter', 'paytax', 'rates', 'format', 'urlState', 'styles', 'tokens'],
  },
  {
    ...
    deps: ['sitefooter', 'paytax', 'rates', 'lmi', 'format', 'urlState', 'styles', 'tokens'],
  },
  {
    ...
    deps: ['sitefooter', 'amortize', 'stampduty', 'lmi', 'paytax', 'rates', 'format', 'urlState', 'styles', 'tokens'],
  },
  {
  ...
  },
  {
    ...
    deps: ['sitefooter', 'format', 'urlState', 'styles', 'tokens'],
  },
  {
