...
export const SHARED = [
  ...
  S('sitefooter','Site footer (about/privacy)','web/src/SiteFooter.jsx'),
  S('appmeta',    'Routes, SEO and store metadata','core/src/appMeta.js'),
...
export const CALCS = [
  {
    id: 'home', name: 'Home', href: '/', version: '1.1.1',
    paths: ['web/src/Home.jsx', 'web/src/Home.css'],
    deps: ['sitefooter', 'appmeta', 'tokens'],
  },
  {
    id: 'mortgage', name: 'Mortgage Repayments', href: '/mortgagecalc', version: '2.1.1',
    paths: ['web/src/CalcInstance.jsx', 'web/src/MortgageCalc.jsx'],
    deps: ['sitefooter', 'appmeta', 'amortize', 'lmi', 'format', 'urlState', 'styles', 'tokens'],
  },
  {
    id: 'paytax', name: 'Pay / Tax', href: '/paytaxcalc', version: '2.1.1',
    paths: ['web/src/PayTaxInstance.jsx', 'web/src/PayTaxCalc.jsx'],
    deps: ['sitefooter', 'appmeta', 'paytax', 'rates', 'format', 'urlState', 'styles', 'tokens'],
  },
  {
    id: 'borrowingpower', name: 'Borrowing Power', href: '/borrowingpowercalc', version: '2.0.1',
    paths: ['web/src/BorrowingPowerInstance.jsx', 'web/src/BorrowingPowerCalc.jsx', 'core/src/borrowingpower.js'],
    deps: ['sitefooter', 'appmeta', 'paytax', 'rates', 'lmi', 'format', 'urlState', 'styles', 'tokens'],
  },
  {
    id: 'rentvbuy', name: 'Rent vs. Buy', href: '/rentvbuycalc', version: '2.0.1',
    paths: ['web/src/RentVBuyInstance.jsx', 'web/src/RentVBuyCalc.jsx', 'core/src/rentvbuy.js'],
    deps: ['sitefooter', 'appmeta', 'amortize', 'stampduty', 'lmi', 'paytax', 'rates', 'format', 'urlState', 'styles', 'tokens'],
  },
  {
    id: 'cgt', name: 'Capital Gains Tax', href: '/cgtcalc', version: '2.0.1',
    paths: ['web/src/CGTInstance.jsx', 'web/src/CGTCalc.jsx', 'core/src/cgt.js'],
    deps: ['sitefooter', 'appmeta', 'paytax', 'rates', 'format', 'urlState', 'styles', 'tokens'],
  },
  {
    id: 'redundancy', name: 'Redundancy Pay', href: '/redundancycalc', version: '2.0.1',
    paths: ['web/src/RedundancyInstance.jsx', 'web/src/RedundancyCalc.jsx', 'core/src/redundancy.js'],
    deps: ['sitefooter', 'appmeta', 'paytax', 'rates', 'format', 'urlState', 'styles', 'tokens'],
  },
  {
    id: 'salarysacrifice', name: 'Salary Sacrifice', href: '/salarysacrificecalc', version: '2.0.1',
    paths: ['web/src/SalarySacrificeInstance.jsx', 'web/src/SalarySacrificeCalc.jsx', 'core/src/salarysacrifice.js'],
    deps: ['sitefooter', 'appmeta', 'paytax', 'rates', 'format', 'urlState', 'styles', 'tokens'],
  },
  {
    id: 'fhsss', name: 'First Home Super Saver', href: '/fhssscalc', version: '2.0.1',
    paths: ['web/src/FHSSSInstance.jsx', 'web/src/FHSSSCalc.jsx', 'core/src/fhsss.js'],
    deps: ['sitefooter', 'appmeta', 'paytax', 'rates', 'format', 'urlState', 'styles', 'tokens'],
  },
  {
    id: 'retirement', name: 'Retirement / Super', href: '/retirementcalc', version: '2.0.1',
    paths: ['web/src/RetirementInstance.jsx', 'web/src/RetirementCalc.jsx', 'core/src/retirement.js'],
    deps: ['sitefooter', 'appmeta', 'paytax', 'rates', 'format', 'urlState', 'styles', 'tokens'],
  },
  {
    id: 'novatedlease', name: 'Novated Lease', href: '/novatedleasecalc', version: '2.0.1',
    paths: ['web/src/NovatedLeaseInstance.jsx', 'web/src/NovatedLeaseCalc.jsx', 'core/src/novatedlease.js'],
    deps: ['sitefooter', 'appmeta', 'paytax', 'rates', 'format', 'urlState', 'styles', 'tokens'],
  },
  {
    id: 'savings', name: 'Savings', href: '/savingscalc', version: '2.0.1',
