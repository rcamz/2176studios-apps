...
export default function HealthCalc() {
  ...
  const handleShare = useCallback(async () => {
    if (navigator.share) await navigator.share({ title: 'Health Calculator — 2176 Studios', url: window.location.href });
    else setModal('share');
  }, []);

  return (
    <div className="calc-page">
      <PageHead calcId="health" />
      ...
      <div className="calc-instances" data-count="1">
        <HealthInstance instanceKey="" theme={theme} isComparison={false} />
      </div>
