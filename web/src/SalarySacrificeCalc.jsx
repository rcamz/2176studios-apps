...
export default function SalarySacrificeCalc() {
  ...
  const handleShare = useCallback(async () => {
    if (navigator.share) await navigator.share({ title: 'Salary Sacrifice Calculator — 2176 Studios', url: canonicalShareUrl() });
    else setModal('share');
  }, []);

  return (
    <div className="calc-page">
      <PageHead calcId="salarysacrifice" />
      ...
      <div className="calc-instances" data-count="1">
        <SalarySacrificeInstance instanceKey="" theme={theme} isComparison={false} />
      </div>
